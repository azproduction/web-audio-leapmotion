...
function init() {
  ...
  var diffuseTexture1 = THREE.ImageUtils.loadTexture( "textures/grasslight-big.jpg", null, function () {
  ...
  var diffuseTexture2 = THREE.ImageUtils.loadTexture( "textures/backgrounddetailed6.jpg", null, loadTextures );
  var detailTexture = THREE.ImageUtils.loadTexture( "textures/grasslight-big-nm.jpg", null, loadTextures );
...
function render() {
  ...
  if ( terrain.visible ) {
    ...
    if ( updateNoise ) {
      ...
      uniformsNoise[ "offset" ].value.x += delta * 0.05 * 0;
